...
namespace TH10 {
    ...
    protected:
        ...
        Gui::GuiHotKey mTimeLock{
            ...
            "F4",
            VK_F4,
            {new HookCtx(0x408D93, "\xeb", 1), new HookCtx(0x40E5B0, "\x90", 1)}
        };
...
#define ANMChangeWord(buffer, pos, value) *((int16_t*)(buffer + pos)) = value;
        if (thPracParam.mode == 1 && thPracParam.section >= TH10_ST6_BOSS1
            && thPracParam.section <= TH10_ST6_BOSS9) {
...
#undef ANMChangeWord
    ...
    void STDSt4Jump(uint32_t pos, uint32_t time, StdStatus& status)
    {
        ...
        std.SetPos(0x600);
        std << 0 << 0x00140002 << status.camPosX << status.camPosY << status.camPosZ << 0
            << 0x00140004 << status.camDirX << status.camDirY << status.camDirZ << 0 << 0x00140008
    ...
    void ECLTimeFix(
        ECLHelper& ecl, size_t pos, int32_t delta_time, unsigned int ins_count = 0xFFFFFFFF
    )
    {
        ecl.SetPos(pos);
        int32_t ecl_time;
    ...
    void ECLSetHealth(
        ECLHelper& ecl, size_t pos, int32_t health, int32_t ecl_time = 0, uint8_t rank_mask = 0xff,
        bool stall = false
    )
    {
        ecl.SetPos(pos);
    ...
    {
        ecl << pair{0x18983, (int8_t)0x37} << pair{0x10bb4, 60} << pair{0x10bc4, 60}
            << pair{0x10bd8, 60} << pair{0x10bec, 60} << pair{0x10c04, 60} << pair{0x10c18, 60}
            << pair{0x10c28, 60} << pair{0x10c48, 60} << pair{0x10c5c, 60} << pair{0x10c70, 60}
            << pair{0x10c88, 60} << pair{0x10c9c, 60} << pair{0x10cb4, 60} << pair{0x10cc8, 60}
    ...
    __declspec(noinline) void THStageWarp(ECLHelper& ecl, int stage, int portion)
    {
        ...
        auto st4_boss_timeskip = [&](uint32_t stdTime) {
            ecl << pair(0x14aa4, 8600 - stdTime) << pair(0x14ab4, 8600 - stdTime)
                << pair(0x14ae4, 8600 - stdTime) << pair(0x14af8, 8601 - stdTime)
                << pair(0x14b08, 8601 - stdTime) << pair(0x14b18, 8601 - stdTime)
                << pair(0x14b2c, 8602 - stdTime);
            ecl << pair(0xf900, 3600 - stdTime) << pair(0xf930, 4100 - stdTime)
                << pair(0xf950, 4100 - stdTime);
        };
        ...
        if (stage == 1) {
            ...
            case 2:
                ...
                ecl << pair(0x143e4, 3800 - 878) << pair(0x143f4, 3800 - 878)
                    << pair(0x14424, 3800 - 878) << pair(0x14434, 3800 - 878)
                    << pair(0x14454, 3800 - 878);
                break;
            case 3:
                ECLJump(ecl, 0xe39c, 0x11e7c, 30); // -1373
                ecl << pair(0x143e4, 3800 - 1373) << pair(0x143f4, 3800 - 1373)
                    << pair(0x14424, 3800 - 1373) << pair(0x14434, 3800 - 1373)
                    << pair(0x14454, 3800 - 1373);
                break;
            case 4:
                ECLJump(ecl, 0xe39c, 0x12e54, 30); // -2873
                ecl << pair(0x143e4, 3800 - 2873) << pair(0x143f4, 3800 - 2873)
                    << pair(0x14424, 3800 - 2873) << pair(0x14434, 3800 - 2873)
                    << pair(0x14454, 3800 - 2873);
                break;
            case 5:
    ...
    __declspec(noinline) void THPatch(ECLHelper& ecl, th_sections_t section)
    {
        ...
        case THPrac::TH10::TH10_ST6_BOSS4:
            ...
            ecl.SetPos(0x1058);
            ecl << 0 << 0x00180103 << 0x02ff0000 << 0 << 1 << 13 << 0 << 0x00180103 << 0x02ff0000
                << 0 << 2 << 14 << 0 << 0x00180103 << 0x02ff0000 << 0 << 3 << 18 << 0 << 0x00180103
                << 0x02ff0000 << 0 << 4 << 19 << 9999 << 0x00100000 << 0x00ff0000 << 0;
            break;
        ...
        case THPrac::TH10::TH10_ST6_BOSS9:
            ...
            ecl << pair{0x88bc, 0};
            ecl.SetPos(0x2a58);
            ecl << 0 << 0x00180103 << 0x02ff0000 << 0 << 3 << 18 << 0 << 0x00180103 << 0x02ff0000
                << 0 << 4 << 19 << 9999 << 0x00100000 << 0x00ff0000 << 0;
        ...
        case THPrac::TH10::TH10_ST7_END_S1:
            ...
            ecl.SetPos(0xde8);
            ecl << 0 << 0x002c014e << 0x04ff0000 << 0 << 0 << 0xaf0 << 0xe10 << 0xc << 0x73736f42
                << 0x64726143 << 0x31;
            *(uint32_t*)0x474c84 = 24;
            break;
    ...
    {
        unsigned char p1[128] = {};
        unsigned char p2[128] = {};
        unsigned char p3[128] = {};
        unsigned char p4[128] = {};
    ...
    {
        unsigned char p1[128] = {};
        unsigned char p2[128] = {};
        unsigned char p3[128] = {};
        unsigned char p4[128] = {};
    ...
    void THReimuCFix(uint8_t* repBuffer)
    {
        unsigned char p1[128] = {0x00, 0x00, 0x00, 0x00, 0xC0, 0x8F, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 ...
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p2[128] = {};
        unsigned char p3[128] = {};
        unsigned char p4[128] = {0x80, 0xF3, 0xFF, 0xFF, 0x40, 0x9C, 0x00, 0x00, 0x80, 0x0C, 0x00,
                                 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0xE7, 0xFF, 0xFF, 0x40, 0x9C,
                                 0x00, 0x00, 0x00, 0x19, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x80,
                                 0xF3, 0xFF, 0xFF, 0x40, 0x9C, 0x00, 0x00, 0x80, 0x0C, 0x00, 0x00,
                                 0x40, 0x9C, 0x00, 0x00, 0x00, 0xE7, 0xFF, 0xFF, 0x40, 0x9C, 0x00,
                                 0x00, 0x00, 0x19, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x80, 0xF3,
                                 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x80, 0x0C, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0xE7, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00,
    ...
    {
        unsigned char p1[128] = {0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 ...
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p2[128] = {0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 ...
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p3[128] = {0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9C,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 ...
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p4[128] = {0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9C,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    void THMarisaBFix(uint8_t* repBuffer)
    {
        unsigned char p1[128] = {0x00, 0x00, 0x00, 0x00, 0xC0, 0x8F, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 ...
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0xA0, 0xF6, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p2[128] = {0x80, 0xF3, 0xFF, 0xFF, 0x40, 0x9C, 0x00, 0x00, 0x80, 0x0C, 0x00,
                                 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 ...
                                 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x80, 0x0C, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xE0, 0xFC, 0xFF,
                                 0xFF, 0xA0, 0xF6, 0xFF, 0xFF, 0x20, 0x03, 0x00, 0x00, 0xA0, 0xF6,
                                 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p3[128] = {0x80, 0xF3, 0xFF, 0xFF, 0x40, 0x9C, 0x00, 0x00, 0x80, 0x0C, 0x00,
                                 0x00, 0x40, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x8F,
                                 ...
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0xF3, 0xFF, 0xFF,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0xF9, 0xFF,
                                 0xFF, 0xA0, 0xF6, 0xFF, 0xFF, 0x40, 0x06, 0x00, 0x00, 0xA0, 0xF6,
                                 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xA0, 0xF6, 0xFF, 0xFF, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p4[128] = {};
    ...
    void THMarisaCFix(uint8_t* repBuffer)
    {
        unsigned char p1[128] = {0x00, 0x00, 0x00, 0x00, 0xC0, 0x8F, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 ...
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0xC0, 0x8F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p2[128] = {};
        unsigned char p3[128] = {};
        unsigned char p4[128] = {};
