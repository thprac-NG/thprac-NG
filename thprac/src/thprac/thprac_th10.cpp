...
#undef ANMChangeWord
    ...
    void STDSt4Jump(uint32_t pos, uint32_t time, StdStatus& status)
    {
        ...
        std.SetPos(0x600);
        std << 0 << 0x00140002 << status.camPosX << status.camPosY << status.camPosZ << 0 << 0x00140004 << status.camDirX << status.camDirY << status.camDirZ << 0 << 0x00140008
            << status.fogCol << status.fogStart << status.fogEnd << 0 << 0x00100001 << pos << time;
    ...
    {
        ecl << pair{0x18983, (int8_t)0x37} << pair{0x10bb4, 60} << pair{0x10bc4, 60} << pair{0x10bd8, 60} << pair{0x10bec, 60} << pair{0x10c04, 60} << pair{0x10c18, 60}
            << pair{0x10c28, 60} << pair{0x10c48, 60} << pair{0x10c5c, 60} << pair{0x10c70, 60} << pair{0x10c88, 60} << pair{0x10c9c, 60} << pair{0x10cb4, 60} << pair{0x10cc8, 60}
            << pair{0x10cdc, 60} << pair{0x10afc, (int16_t)0};
        ECLJump(ecl, 0x171a8, 0x171cc, 61);
    }
    void ECLSt7Boss(ECLHelper& ecl)
    {
        ecl << pair{0x18983, (int8_t)0x42} << pair{0x18984, (int8_t)0x6f} << pair{0x18985, (int8_t)0x73} << pair{0x18986, (int8_t)0x73};
    ...
    __declspec(noinline) void THStageWarp(ECLHelper& ecl, int stage, int portion)
    {
        ...
        auto st4_boss_timeskip = [&](uint32_t stdTime) {
            ecl << pair(0x14aa4, 8600 - stdTime) << pair(0x14ab4, 8600 - stdTime) << pair(0x14ae4, 8600 - stdTime) << pair(0x14af8, 8601 - stdTime) << pair(0x14b08, 8601 - stdTime)
                << pair(0x14b18, 8601 - stdTime) << pair(0x14b2c, 8602 - stdTime);
            ecl << pair(0xf900, 3600 - stdTime) << pair(0xf930, 4100 - stdTime) << pair(0xf950, 4100 - stdTime);
        };
        ...
        if (stage == 1) {
            ...
            case 2:
                ...
                ecl << pair(0x143e4, 3800 - 878) << pair(0x143f4, 3800 - 878) << pair(0x14424, 3800 - 878) << pair(0x14434, 3800 - 878) << pair(0x14454, 3800 - 878);
                break;
            case 3:
                ECLJump(ecl, 0xe39c, 0x11e7c, 30); // -1373
                ecl << pair(0x143e4, 3800 - 1373) << pair(0x143f4, 3800 - 1373) << pair(0x14424, 3800 - 1373) << pair(0x14434, 3800 - 1373) << pair(0x14454, 3800 - 1373);
                break;
            case 4:
                ECLJump(ecl, 0xe39c, 0x12e54, 30); // -2873
                ecl << pair(0x143e4, 3800 - 2873) << pair(0x143f4, 3800 - 2873) << pair(0x14424, 3800 - 2873) << pair(0x14434, 3800 - 2873) << pair(0x14454, 3800 - 2873);
                break;
            case 5:
    ...
    __declspec(noinline) void THPatch(ECLHelper& ecl, th_sections_t section)
    {
        ...
        case THPrac::TH10::TH10_ST2_BOSS5:
            ...
            ecl << pair{0x990, (int8_t)0x32};
            ECLJump(ecl, 0x1d8c, 0x1df8, 120);
            ecl << pair{0x1bf4, (int8_t)0x33} << pair{0x1bc8, 2700} << pair{0x1be0, 2700};
            break;
        ...
        case THPrac::TH10::TH10_ST4_BOSS7:
            ...
            ecl << pair{0x928, (int8_t)0x33};
            ECLJump(ecl, 0x2628, 0x2694, 120);
            ecl << pair{0x242c, 2300} << pair{0x2440, 0} << pair{0x2498, (int8_t)0x34};
            ecl.SetPos(0x6bc4);
        ...
        case THPrac::TH10::TH10_ST5_BOSS2:
            ECLJump(ecl, 0x14ba0, 0x14bc0, 0);
            ecl << pair{0x14bdb, (int8_t)0x42} << pair{0x14bdc, 0x0073736f} << pair{0x1432c, (int16_t)0} << pair{0x14370, (int16_t)0};
        ...
        case THPrac::TH10::TH10_ST6_BOSS4:
            ...
            ecl.SetPos(0x1058);
            ecl << 0 << 0x00180103 << 0x02ff0000 << 0 << 1 << 13 << 0 << 0x00180103 << 0x02ff0000 << 0 << 2 << 14 << 0 << 0x00180103 << 0x02ff0000 << 0 << 3 << 18 << 0
                << 0x00180103 << 0x02ff0000 << 0 << 4 << 19 << 9999 << 0x00100000 << 0x00ff0000 << 0;
            break;
        ...
        case THPrac::TH10::TH10_ST6_BOSS9:
            ...
            ecl << pair{0x88bc, 0};
            ecl.SetPos(0x2a58);
            ecl << 0 << 0x00180103 << 0x02ff0000 << 0 << 3 << 18 << 0 << 0x00180103 << 0x02ff0000 << 0 << 4 << 19 << 9999 << 0x00100000 << 0x00ff0000 << 0;
        ...
        case THPrac::TH10::TH10_ST7_MID1:
            ecl << pair{0x18983, (int8_t)0x37} << pair{0x10bb4, 60} << pair{0x10bc4, 60} << pair{0x10bd8, 60} << pair{0x10bec, 60} << pair{0x10c04, 60} << pair{0x10c18, 60}
                << pair{0x10c28, 60} << pair{0x10c48, 60} << pair{0x10c5c, 60} << pair{0x10c70, 60} << pair{0x10c88, 60} << pair{0x10c9c, 60} << pair{0x10cb4, 60}
                << pair{0x10cc8, 60} << pair{0x10cdc, 60} << pair{0x10afc, (int16_t)0};
            if (!thPracParam.dlg)
                ECLJump(ecl, 0x171a8, 0x171cc, 61);
            break;
        ...
        case THPrac::TH10::TH10_ST7_END_S1:
            ...
            ecl.SetPos(0xde8);
            ecl << 0 << 0x002c014e << 0x04ff0000 << 0 << 0 << 0xaf0 << 0xe10 << 0xc << 0x73736f42 << 0x64726143 << 0x31;
            *(uint32_t*)0x474c84 = 24;
            break;
        ...
        case THPrac::TH10::TH10_ST7_END_S9:
            ECLSt7Boss(ecl);
            ecl << pair{0xcec, 0xc} << pair{0xcf4, 0x64726143} << pair{0xcf8, 0x39};
            ECLJump(ecl, 0xb3d8, 0xb444, 80);
            *(uint32_t*)0x474c84 = 24;
            break;
        case THPrac::TH10::TH10_ST7_END_S10:
            ECLSt7Boss(ecl);
            ecl << pair{0xcec, 0xc} << pair{0xcf4, 0x64726143} << pair{0xcf8, 0x3031};
    ...
    {
        unsigned char p1[128] = {};
        unsigned char p2[128] = {};
        unsigned char p3[128] = {};
        unsigned char p4[128] = {};
    ...
    {
        unsigned char p1[128] = {};
        unsigned char p2[128] = {};
        unsigned char p3[128] = {};
        unsigned char p4[128] = {};
    ...
    void THReimuCFix(uint8_t* repBuffer)
    {
        unsigned char p1[128] = {0x00, 0x00, 0x00, 0x00, 0xC0, 0x8F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 ...
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p2[128] = {};
        unsigned char p3[128] = {};
        unsigned char p4[128] = {};
    ...
    {
        unsigned char p1[128] = {};
        unsigned char p2[128] = {};
        unsigned char p3[128] = {};
        unsigned char p4[128] = {};
    ...
    void THMarisaBFix(uint8_t* repBuffer)
    {
        unsigned char p1[128] = {0x00, 0x00, 0x00, 0x00, 0xC0, 0x8F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 ...
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x80, 0xF3, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA0, 0xF6, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p2[128] = {};
        unsigned char p3[128] = {};
        unsigned char p4[128] = {};
    ...
    void THMarisaCFix(uint8_t* repBuffer)
    {
        unsigned char p1[128] = {0x00, 0x00, 0x00, 0x00, 0xC0, 0x8F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 ...
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x80, 0xF3, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x8F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        unsigned char p2[128] = {};
        unsigned char p3[128] = {};
        unsigned char p4[128] = {};
    ...
    EHOOK_DY(th10_everlasting_bgm, 0x43e460)
    {
        ...
        result = ElBgmTest<0x420b42, 0x4180a7, 0x422be1, 0x422c51, 0x4183e6>(el_switch, is_practice, retn_addr, bgm_cmd, bgm_id, call_addr);
    ...
    {
        // Init
        GameGuiInit(IMPL_WIN32_DX9, 0x491c30, 0x4924f0, 0x4390e0, Gui::INGAGME_INPUT_GEN2, 0x474e36, 0x474e34, 0, -1);
