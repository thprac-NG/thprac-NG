...
#define FORCE_BOSS(boss_index, start_index)                                                                                                                                        \
    0x00, 0x00, 0x00, 0x00, 0xF3 * (boss_index == 0), 0x03 * (boss_index == 0), 0x18, 0x00, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00, (start_index), 0x00, 0x00, 0x00, 0x01, \
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF3 * (boss_index == 1), 0x03 * (boss_index == 1), 0x18, 0x00, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00,                  \
        (start_index) + 1, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF3 * (boss_index == 2), 0x03 * (boss_index == 2), 0x18, 0x00, 0x00, 0x00, 0xFF,     \
        0x02, 0x00, 0x00, 0x00, 0x00, (start_index) + 2, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x00, 0x01, 0x00, 0xFF, 0x01, 0x00,   \
        0x00, 0x00, 0x00, 0x5E, 0xD9, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00, 0x30, 0x00, 0x00, 0x00, 0x00,    \
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF3 * (boss_index == 3), 0x03 * (boss_index == 3), 0x18, 0x00, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00,                  \
        (start_index) + 3, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00

#define FORCE_BOSS_C(boss_index, start_index)                                                                                                                                      \
    0x00, 0x00, 0x00, 0x00, 0xF3 * (boss_index == 0), 0x03 * (boss_index == 0), 0x18, 0x00, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00, (start_index), 0x00, 0x00, 0x00, 0x01, \
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF3 * (boss_index == 1), 0x03 * (boss_index == 1), 0x18, 0x00, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00,                  \
        (start_index) + 1, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF3 * (boss_index == 2), 0x03 * (boss_index == 2), 0x18, 0x00, 0x00, 0x00, 0xFF,     \
        0x02, 0x00, 0x00, 0x00, 0x00, (start_index) + 2, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF3 * (boss_index == 3), 0x03 * (boss_index == 3),     \
        0x18, 0x00, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00, (start_index) + 3, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00

#define BOSS_SPELL_CARD_ASYNC(boss_id, spell_id)                                                                                                                                  \
    0x00, 0x00, 0x00, 0x00, 0x0B, 0x00, 0x24, 0x00, 0x00, 0x00, 0xFF, 0x01, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x42, 0x6F, 0x73, 0x73, boss_id / 10 + 0x30,          \
        boss_id % 10 + 0x30, 0x42, 0x6F, 0x73, 0x73, 0x43, 0x61, 0x72, 0x64, 0x30 + spell_id, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0A, 0x00, 0x10, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, \
        0x00, 0x00, 0x00
        ...
        case 0:
            out.section_param = {
                ...
                {.label = S(TH185_WAVE_2), .jumps = {{"main", {{.off = 0x188, .dest = 0x2fc}}}}, .writes = {{"main", {{.off = 0x184, .bytes = {2}}}}}},
                {.label = S(TH185_WAVE_3), .jumps = {{"main", {{.off = 0x188, .dest = 0x3b8}}}}, .writes = {{"main", {{.off = 0x184, .bytes = {3}}}}}},
                {.label = S(TH_BOSS), .jumps = {{"main", {{.off = 0x188, .dest = 0x488}}}}, .writes = {{"main", {{.off = 0x184, .bytes = {4}}}}}}
            };
        ...
        case 1:
            out.section_param = {
                ...
                {.label = S(TH185_WAVE_2), .jumps = {{"main", {{.off = 0x258, .dest = 0x380}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x02, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_3), .jumps = {{"main", {{.off = 0x258, .dest = 0x44c}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x03, 0x00, 0x00, 0x00}}}}}},
            ...
            out.section_param[3].phases = {
                ...
                .section_param = {
                                  ...
                                  {.label = "Mike Goutokuji", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(0, 2)}}}}}},
                                  {.label = "Minoriko Aki", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(1, 2)}}}}}},
                                  {.label = "Eternity Larva", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(2, 2)}}}}}},
                                  {.label = "Nemuno Sakata", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(3, 2)}}}}}}}
            };
        ...
        case 2:
            out.section_param = {
                ...
                {.label = S(TH185_WAVE_2), .jumps = {{"main", {{.off = 0x258, .dest = 0x380}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x02, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_3), .jumps = {{"main", {{.off = 0x258, .dest = 0x44c}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x03, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_4), .jumps = {{"main", {{.off = 0x258, .dest = 0x51c}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x04, 0x00, 0x00, 0x00}}}}}},
            ...
            out.section_param[4].phases = {
                ...
                .section_param = {
                                  {.label = S(TH185_NONE_RANDOM)},
                                  {.label = "Cirno", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(0, 6)}}}}}},
                                  {.label = "Wakasagihime", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(1, 6)}}}}}},
                                  {.label = "Sekibanki", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(2, 6)}}}}}},
                                  {.label = "Urumi Ushizaki", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(3, 6)}}}}}}}
            };
        ...
        case 3:
            out.section_param = {
                ...
                {.label = S(TH185_WAVE_3), .jumps = {{"main", {{.off = 0x258, .dest = 0x44c}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x03, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_4), .jumps = {{"main", {{.off = 0x258, .dest = 0x51c}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x04, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_5), .jumps = {{"main", {{.off = 0x258, .dest = 0x5e8}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x05, 0x00, 0x00, 0x00}}}}}},
                {
                 .label = S(TH_BOSS),
            ...
            out.section_param[5].phases = {
                ...
                .section_param = {
                                  {.label = S(TH185_NONE_RANDOM)},
                                  {.label = "Eika Ebisu", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(0, 10)}}}}}},
                                  {.label = "Kutaka Niwatari", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(1, 10)}}}}}},
                                  {.label = "Narumi Yatadera", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(2, 10)}}}}}},
                                  {.label = "Komachi Onozuka", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(3, 10)}}}}}}}
            };
        ...
        case 4:
            out.section_param = {
                ...
                {.label = S(TH185_WAVE_2), .jumps = {{"main", {{.off = 0x258, .dest = 0x380}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x02, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_3), .jumps = {{"main", {{.off = 0x258, .dest = 0x44c}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x03, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_4), .jumps = {{"main", {{.off = 0x258, .dest = 0x518}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x04, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_5), .jumps = {{"main", {{.off = 0x258, .dest = 0x5e4}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x05, 0x00, 0x00, 0x00}}}}}},
                {
                 .label = S(TH_BOSS),
            ...
            out.section_param[5].phases = {
                ...
                .section_param = {
                                  {.label = S(TH185_NONE_RANDOM)},
                                  {.label = "Sanae Kochiya", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(0, 14)}}}}}},
                                  {.label = "Sakuya Izayoi", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(1, 14)}}}}}},
                                  {.label = "Youmu Konpaku", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(2, 14)}}}}}},
                                  {.label = "Reimu Hakurei", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(3, 14)}}}}}},
                                  {.label = "Nitori Kawashiro",
                     .writes = {
                         {"WorldWaveB00",
                          {{.off = 0x34, .bytes = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00, 14,   0x00, 0x00, 0x00,
                                                   0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00,
                                                   15,   0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0xFF, 0x02,
                                                   0x00, 0x00, 0x00, 0x00, 16,   0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x00,
                                                   ...
                                                   0xF3, 0x03, 0x18, 0x00, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00, 27,   0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00}}}}}}}
            };
            out.section_param[5].phases->section_param[1].phases = {
                .label = S(TH_ATTACK),
                .type = stage_warps_t::TYPE_COMBO,
        ...
        case 5:
            out.section_param = {
                {.label = S(TH185_WAVE_1)},
                {.label = S(TH185_WAVE_2), .jumps = {{"main", {{.off = 0x28c, .dest = 0x3b4}}}}, .writes = {{"main", {{.off = 0x28a, .bytes = {0x02, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_3), .jumps = {{"main", {{.off = 0x28c, .dest = 0x480}}}}, .writes = {{"main", {{.off = 0x28a, .bytes = {0x03, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_4), .jumps = {{"main", {{.off = 0x28c, .dest = 0x54c}}}}, .writes = {{"main", {{.off = 0x28a, .bytes = {0x04, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_5), .jumps = {{"main", {{.off = 0x28c, .dest = 0x618}}}}, .writes = {{"main", {{.off = 0x28a, .bytes = {0x05, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_6), .jumps = {{"main", {{.off = 0x28c, .dest = 0x6e4}}}}, .writes = {{"main", {{.off = 0x28a, .bytes = {0x06, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_7), .jumps = {{"main", {{.off = 0x28c, .dest = 0x7b0}}}}, .writes = {{"main", {{.off = 0x28a, .bytes = {0x07, 0x00, 0x00, 0x00}}}}}},
                {
                 .label = S(TH_BOSS),
            ...
            out.section_param[7].phases = {
                ...
                .section_param = {
                                  {.label = S(TH185_NONE_RANDOM)},
                                  {.label = "Tsukasa Kudamaki", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(0, 18)}}}}}},
                                  {.label = "Megumu Iizunamaru", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(1, 18)}}}}}},
                                  {.label = "Clownpiece", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(2, 18)}}}}}},
                                  {.label = "Tenshi Hinanawi", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(3, 18)}}}}}}}
            };
        ...
        case 6:
            out.section_param = {
                ...
                {.label = S(TH185_WAVE_4), .jumps = {{"main", {{.off = 0x258, .dest = 0x518}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x04, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_5), .jumps = {{"main", {{.off = 0x258, .dest = 0x5e4}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x05, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_6), .jumps = {{"main", {{.off = 0x258, .dest = 0x6b0}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x06, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_7), .jumps = {{"main", {{.off = 0x258, .dest = 0x77c}}}}, .writes = {{"main", {{.off = 0x254, .bytes = {0x07, 0x00, 0x00, 0x00}}}}}},
                {
                 .label = S(TH_BOSS),
            ...
            out.section_param[7].phases = {
                ...
                .section_param = {
                                  {.label = S(TH185_NONE_RANDOM)},
                                  {.label = "Suika Ibuki", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(0, 22)}}}}}},
                                  {.label = "Mamizou Futatsuiwa", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(1, 22)}}}}}},
                                  {.label = "Saki Kurokoma", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(2, 22)}}}}}},
                                  {.label = "Momoyo Himemushi", .writes = {{"WorldWaveB00", {{.off = 0x34, .bytes = {FORCE_BOSS(3, 22)}}}}}},
                      ...
                      .writes =
                          {{"Boss27Boss", {{.off = 0x208, .bytes = {0, 0}}, {.off = 0x1b0, .bytes = {0x88, 0x2c, 0x00, 0x00}}}},
                           {"Boss27Boss1",
                            {{.off = 0x10,
                              .bytes =
                                  {0x00, 0x00, 0x00, 0x00, 0x0F, 0x02, 0x1C, 0x00, 0x00, 0x00, 0xFF, 0x03, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
        ...
        case 8:
            out.section_param = {
                ...
                {.label = S(TH185_WAVE_2), .jumps = {{"main", {{.off = 0x434, .dest = 0x52c}}}}, .writes = {{"main", {{.off = 0x3f0, .bytes = {0x02, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_3), .jumps = {{"main", {{.off = 0x434, .dest = 0x628}}}}, .writes = {{"main", {{.off = 0x3f0, .bytes = {0x03, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_4), .jumps = {{"main", {{.off = 0x434, .dest = 0x6d8}}}}, .writes = {{"main", {{.off = 0x3f0, .bytes = {0x04, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_5), .jumps = {{"main", {{.off = 0x434, .dest = 0x7d4}}}}, .writes = {{"main", {{.off = 0x3f0, .bytes = {0x05, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_6), .jumps = {{"main", {{.off = 0x434, .dest = 0x884}}}}, .writes = {{"main", {{.off = 0x3f0, .bytes = {0x06, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_7), .jumps = {{"main", {{.off = 0x434, .dest = 0x980}}}}, .writes = {{"main", {{.off = 0x3f0, .bytes = {0x07, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_8), .jumps = {{"main", {{.off = 0x434, .dest = 0xa30}}}}, .writes = {{"main", {{.off = 0x3f0, .bytes = {0x08, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_9), .jumps = {{"main", {{.off = 0x434, .dest = 0xb2c}}}}, .writes = {{"main", {{.off = 0x3f0, .bytes = {0x09, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_10), .jumps = {{"main", {{.off = 0x434, .dest = 0xbdc}}}}, .writes = {{"main", {{.off = 0x3f0, .bytes = {0x0a, 0x00, 0x00, 0x00}}}}}},
                {.label = S(TH185_WAVE_11), .jumps = {{"main", {{.off = 0x434, .dest = 0xcd8}}}}, .writes = {{"main", {{.off = 0x3f0, .bytes = {0x0b, 0x00, 0x00, 0x00}}}}}},
            ...
            out.section_param[1].phases = {
                ...
                .section_param = {
                                  {
                        .label = S(TH185_NONE_RANDOM),
                    }, {.label = "Mike Goutokuji", .writes = {{"WorldWaveB01", {{.off = 0x34, .bytes = {FORCE_BOSS_C(0, 2)}}}}}},
                                  {.label = "Minoriko Aki", .writes = {{"WorldWaveB01", {{.off = 0x34, .bytes = {FORCE_BOSS_C(1, 2)}}}}}},
                                  {.label = "Eternity Larva", .writes = {{"WorldWaveB01", {{.off = 0x34, .bytes = {FORCE_BOSS_C(2, 2)}}}}}},
                                  {.label = "Nemuno Sakata", .writes = {{"WorldWaveB01", {{.off = 0x34, .bytes = {FORCE_BOSS_C(3, 2)}}}}}}}
            };
            out.section_param[3].phases = {
                .label = S(TH_BOSS),
                .type = stage_warps_t::TYPE_COMBO,
                .section_param = {
                                  {.label = S(TH185_NONE_RANDOM)},
                                  {.label = "Cirno", .writes = {{"WorldWaveB02", {{.off = 0x34, .bytes = {FORCE_BOSS_C(0, 6)}}}}}},
                                  {.label = "Wakasagihime", .writes = {{"WorldWaveB02", {{.off = 0x34, .bytes = {FORCE_BOSS_C(1, 6)}}}}}},
                                  {.label = "Sekibanki", .writes = {{"WorldWaveB02", {{.off = 0x34, .bytes = {FORCE_BOSS_C(2, 6)}}}}}},
                                  {.label = "Urumi Ushizaki", .writes = {{"WorldWaveB02", {{.off = 0x34, .bytes = {FORCE_BOSS_C(3, 6)}}}}}}}
            };
            out.section_param[5].phases = {
                .label = S(TH_BOSS),
                .type = stage_warps_t::TYPE_COMBO,
                .section_param = {
                                  {.label = S(TH185_NONE_RANDOM)},
                                  {.label = "Eika Ebisu", .writes = {{"WorldWaveB03", {{.off = 0x34, .bytes = {FORCE_BOSS_C(0, 10)}}}}}},
                                  {.label = "Kutaka Niwatari", .writes = {{"WorldWaveB03", {{.off = 0x34, .bytes = {FORCE_BOSS_C(1, 10)}}}}}},
                                  {.label = "Narumi Yatadera", .writes = {{"WorldWaveB03", {{.off = 0x34, .bytes = {FORCE_BOSS_C(2, 10)}}}}}},
                                  {.label = "Komachi Onozuka", .writes = {{"WorldWaveB03", {{.off = 0x34, .bytes = {FORCE_BOSS_C(3, 10)}}}}}}}
            };
            out.section_param[7].phases = {
                .label = S(TH_BOSS),
                .type = stage_warps_t::TYPE_COMBO,
                .section_param = {
                                  {.label = S(TH185_NONE_RANDOM)},
                                  {.label = "Sanae Kochiya", .writes = {{"WorldWaveB04", {{.off = 0x34, .bytes = {FORCE_BOSS_C(0, 14)}}}}}},
                                  {.label = "Sakuya Izayoi", .writes = {{"WorldWaveB04", {{.off = 0x34, .bytes = {FORCE_BOSS_C(1, 14)}}}}}},
                                  {.label = "Youmu Konpaku", .writes = {{"WorldWaveB04", {{.off = 0x34, .bytes = {FORCE_BOSS_C(2, 14)}}}}}},
                                  {.label = "Reimu Hakurei", .writes = {{"WorldWaveB04", {{.off = 0x34, .bytes = {FORCE_BOSS_C(3, 14)}}}}}}}
            };
            out.section_param[9].phases = {
                ...
                .section_param = {
                                  {.label = S(TH185_NONE_RANDOM)},
                                  {.label = "Tsukasa Kudamaki", .writes = {{"WorldWaveB05", {{.off = 0x34, .bytes = {FORCE_BOSS_C(0, 18)}}}}}},
                                  {.label = "Megumu Iizunamaru", .writes = {{"WorldWaveB05", {{.off = 0x34, .bytes = {FORCE_BOSS_C(1, 18)}}}}}},
                                  {.label = "Clownpiece", .writes = {{"WorldWaveB05", {{.off = 0x34, .bytes = {FORCE_BOSS_C(2, 18)}}}}}},
                                  {.label = "Tenshi Hinanawi", .writes = {{"WorldWaveB05", {{.off = 0x34, .bytes = {FORCE_BOSS_C(3, 18)}}}}}}}
            };
            out.section_param[11].phases = {
                ...
                .section_param = {
                                  {.label = S(TH185_NONE_RANDOM)},
                                  {.label = "Suika Ibuki", .writes = {{"WorldWaveB06", {{.off = 0x34, .bytes = {FORCE_BOSS_C(0, 22)}}}}}},
                                  {.label = "Mamizou Futatsuiwa", .writes = {{"WorldWaveB06", {{.off = 0x34, .bytes = {FORCE_BOSS_C(1, 22)}}}}}},
                                  {.label = "Saki Kurokoma", .writes = {{"WorldWaveB06", {{.off = 0x34, .bytes = {FORCE_BOSS_C(2, 22)}}}}}},
                                  {.label = "Momoyo Himemushi", .writes = {{"WorldWaveB06", {{.off = 0x34, .bytes = {FORCE_BOSS_C(3, 22)}}}}}}}
            };
...
#undef BOSS_SPELL_CARD_ASYNC
    ...
    protected:
        ...
        Gui::GuiHotKey mInfLives{
            TH_INFLIVES, "F2", VK_F2, {new HookCtx(0x40aec3, "\x66\x0f\x1f\x44\x00\x00", 6), new HookCtx(0x463281, "\x00", 1)}
        };
        Gui::GuiHotKey mInfBMoney{
            TH185_INF_BMONEY,
            "F3",
            VK_F3,
            {new HookCtx(0x40ed5f, "\x66\x2e\x0f\x1f\x84\x00\x00\x00\x00\x00\x66\x2e\x0f\x1f\x84\x00\x00\x00\x00\x00", 20), new HookCtx(0x41ee2d, "\x66\x0f\x1f\x44\x00\x00", 6)}
        };
    ...
    protected:
        virtual void OnLocaleChange() override
        {
            ...
            const th_glossary_t cardIds[] = {
                TH185_CARD_0,  TH185_CARD_1,  TH185_CARD_2,  TH185_CARD_3,  TH185_CARD_4,  TH185_CARD_5,  TH185_CARD_6,  TH185_CARD_7,  TH185_CARD_8,  TH185_CARD_9,  TH185_CARD_10,
                TH185_CARD_11, TH185_CARD_12, TH185_CARD_13, TH185_CARD_14, TH185_CARD_15, TH185_CARD_16, TH185_CARD_17, TH185_CARD_18, TH185_CARD_19, TH185_CARD_20, TH185_CARD_21,
                TH185_CARD_22, TH185_CARD_23, TH185_CARD_24, TH185_CARD_25, TH185_CARD_26, TH185_CARD_27, TH185_CARD_28, TH185_CARD_29, TH185_CARD_30, TH185_CARD_31, TH185_CARD_32,
                TH185_CARD_33, TH185_CARD_34, TH185_CARD_35, TH185_CARD_36, TH185_CARD_37, TH185_CARD_38, TH185_CARD_39, TH185_CARD_40, TH185_CARD_41, TH185_CARD_42, TH185_CARD_43,
                TH185_CARD_44, TH185_CARD_45, TH185_CARD_46, TH185_CARD_47, TH185_CARD_48, TH185_CARD_49, TH185_CARD_50, TH185_CARD_51, TH185_CARD_52, TH185_CARD_53, TH185_CARD_54,
                TH185_CARD_55, TH185_CARD_56, TH185_CARD_57, TH185_CARD_58, TH185_CARD_59, TH185_CARD_60, TH185_CARD_61, TH185_CARD_62, TH185_CARD_63, TH185_CARD_64, TH185_CARD_65,
                TH185_CARD_66, TH185_CARD_67, TH185_CARD_68, TH185_CARD_69, TH185_CARD_70, TH185_CARD_71, TH185_CARD_72, TH185_CARD_73, TH185_CARD_74, TH185_CARD_75, TH185_CARD_76,
                TH185_CARD_77, TH185_CARD_78, TH185_CARD_79, TH185_CARD_80, TH185_CARD_81, TH185_CARD_82, TH185_CARD_83, TH185_CARD_84};
    ...
    EHOOK_DY(th185_gui_update, 0x4013dd)
    {
        ...
        if (uintptr_t game_thread = GetMemContent(GAME_THREAD_PTR); game_thread && !(GetMemContent(game_thread + 0xb0) & 0x10))
    ...
    {
        // Init
        GameGuiInit(IMPL_WIN32_DX9, 0x4d52c8, 0x571d50, 0x474760, Gui::INGAGME_INPUT_GEN2, 0x4ce400, 0x4ce3f8, 0, -2, *(float*)0x573dc0, 0.0f);
