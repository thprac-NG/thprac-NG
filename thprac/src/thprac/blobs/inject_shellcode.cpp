...
// 1) Run "cl /O1 inject_shellcode.cpp /link /NODEFAULTLIB /DLL" in an x86 native tools command
// prompt inside this folder 2) Open the generated inject_shellcode.exe in something like x64dbg and
// copy paste every byte of the generated InjectShellcode
